...
const CreateCustomer = ({ navigation, route }) => {
    ...
    const handleSave = () => {
        ...
        console.log('Saving customer:', name, phoneNumber);

        navigation.navigate('Transaction', { 'name': name, 'phoneNumber': phoneNumber, 'accountId': accountId });
    };

    return (
        
        <View>
            <CustomHeader title="Create Customer" /> 
