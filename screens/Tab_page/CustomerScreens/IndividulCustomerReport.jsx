...
const IndividulCustomerReport = ({ route, navigation }) => {
...
const [startDate, setStartDate] = useState(initialStartDate);
  ...
  const generateHTML = () => {
    ...
    const tableRows = Object.entries(groupedData).map(([interval, data]) => {
      ...
      console.log(data) // Initialize running balance for each interval
      ...
      <html>
        ...
        <body>
          <div class="container">
            ...
            <div class="start-using-app">Start using Khata Book app now! Install</div>
          </div>
        </body>
      </html>
    `;
...
export default IndividulCustomerReport;
